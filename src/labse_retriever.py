...
class DocumentGroundedDialogRetrievalTrainer():
    ...
    def __init__(self, model: str, revision='v1.0.0', *args, **kwargs):
        ...
        self.preprocessor = AutoTokenizer.from_pretrained(model)
...
mpdel = RetrievalModel("bert", Eq, Ep, args=model_args, use_cuda=True)
